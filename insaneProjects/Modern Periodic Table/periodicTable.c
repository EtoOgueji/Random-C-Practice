...
int main()
{
    ...
    else if (n == 2)
    {
        ...
        if (Exit == 6)
        {
            ...
            {
                printf("Periodic table has not close and you can continue to learn more about elements\n\n");
        ...
        {
            printf("Periodic table has not closed and you cn continue to learn the elements\n\n");
